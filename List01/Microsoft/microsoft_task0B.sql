...
-- Disable this constraint so that data insertion can be performed without issues
ALTER TABLE Bandy NOCHECK CONSTRAINT fk_kocury_szef_bandy;
...
-- Disable this constraint so that data insertion can be performed without issues
ALTER TABLE Kocury NOCHECK CONSTRAINT fk_kocury_szef;
...
-- Enable the previously disabled constraints
ALTER TABLE Bandy  CHECK CONSTRAINT fk_kocury_szef_bandy;
ALTER TABLE Kocury CHECK CONSTRAINT fk_kocury_szef;
